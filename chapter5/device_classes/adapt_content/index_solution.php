...
<html>
<head>
  <title>Bestanden! Lernhilfen</title>
...
<div id="feature">
  <div id="featured_product">
    <?php if ($device_class == 'desktop'): ?>
      <p>Flash-Präsentation mit Produktvorstellung.</p>
    <?php else: ?>
      <p>Statisches Bild des vorgestellten Produkts.</p>
    <?php endif; ?>
  </div>
</div>
...
<div id="footer">
  <p class="attribution">Buchfoto von <a href="http://www.flickr.com/photos/shutterhacks/">Shutterhacks</a></p>
  <p>Aktuelle Gerätklasse: <?php print $device_class; ?></p>
</div>
