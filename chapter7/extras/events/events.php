  ...
  <div data-role="page">
    ...
    <div data-role="content">
      <ul data-role="listview" data-inset="true">
        ...
        if ($search->isSearch()): ?>
          <li data-role="list-divider"><h3>Passende Events</h3></li>
        <?php endif; ?>
        ...
        <?php if ($search->isSearch() && !$search->hasMatchingEvents()): ?>
          <li><strong>Leider konnten keine passenden Events gefunden werden!</strong></li>
        <?php endif; ?>
      </ul>
    </div><!-- /content -->
    ...
    <div data-role="footer" data-position="fixed">
      <div data-role="navbar"> 
        <ul> 
          <li><a href="index.php" data-icon="info">Über uns</a></li> 
